// controllers/Organisation/AccessController.js
const Organisation = require('../../models/Organisation');
const Teacher = require('../../models/Teacher');
const isEmpty = require('is-empty');

class AccessController {
  // Get all permissions for a teacher in an organisation
  static async getTeacherPermissions(req, res) {
    try {
  ...
  // Update permissions for a teacher in an organisation
  static async updateTeacherPermissions(req, res) {
    try {
      const { organisationId, teacherId } = req.params;
      const teacherIdNum = parseInt(teacherId);
  ...
  // Update specific permission for a teacher in an organisation
  static async updateSpecificPermission(req, res) {
    try {
  ...
  // Get all teachers with specific permission in an organisation
  static async getTeachersWithPermission(req, res) {
    try {
  ...
  // Get permission summary for an organisation
  static async getPermissionSummary(req, res) {
    try {
  ...
  static async checkTeacherPermission(req, res) {
    try {
      const { organisationId, teacherId, permissionType } = req.params;
      const teacherIdNum = parseInt(teacherId);
