// controllers/Organisation/TeacherController.js
const Organisation = require('../../models/Organisation');
const Teacher = require('../../models/Teacher');
const isEmpty = require('is-empty');

class TeacherController {
  // Register a new teacher within an organisation
  ...
  // Get all teachers in an organisation
  ...
  // Get a specific teacher in an organisation
  ...
  // Update a teacher in an organisation
  ...
  // Remove a teacher from an organisation
  ...
  // Get teachers by subject in an organisation
  ...
  // Get teachers by class in an organisation
  ...
  // Get active teachers in an organisation
  ...
  // Get teacher count in an organisation
  static async getTeacherCount(req, res) {
    try {
      const { organisationId } = req.params;
